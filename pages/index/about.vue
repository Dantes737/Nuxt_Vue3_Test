<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="lg:pr-4">
          <div class="max-w-xl text-base leading-7 text-black lg:max-w-lg">
            <p>
            ...
            <h2 class="mt-16 text-2xl font-bold tracking-tight text-slate-300">
